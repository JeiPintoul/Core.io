...
export const GameEvents = {
    ...
    CARD_REROLL_REQUESTED: 'card_reroll_requested',
    UPGRADE_DEFERRED: 'upgrade_deferred',
    UPGRADE_REOPEN_REQUESTED: 'upgrade_reopen_requested',
    SHOW_TANK_EVOLUTION_MODAL: 'show_tank_evolution_modal',
    UPDATE_TANK_EVOLUTION_MODAL: 'update_tank_evolution_modal',
    HIDE_TANK_EVOLUTION_MODAL: 'hide_tank_evolution_modal',
    TANK_EVOLUTION_SELECTED: 'tank_evolution_selected',
    TANK_EVOLUTION_REOPEN_REQUESTED: 'tank_evolution_reopen_requested',
    TANK_EVOLUTION_CHOICE_OPENED: 'tank_evolution_choice_opened',
    TANK_EVOLUTION_CHOICE_CLOSED: 'tank_evolution_choice_closed',
    GAME_OVER: 'game_over',
